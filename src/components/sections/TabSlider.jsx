...
import {executeGetContent, executeGetContentByCategoryId} from "../../api/endPoints.jsx";
...
const TabSlider = memo(() => {
  ...
  const themeSchemeDirection = useSelector(theme_scheme_direction);
    ...
    const getContent = async () => {
        // console.log('content Data Execute Movie  start');
        try {
            const response = await executeGetContent("36SErmCtUbHN29JoByFZ");
            // console.log('category id  Data :==============>>>', response.data["data"]);
            ...
            {contentData && contentData
              ...
              >
                <div className="tab-slider-banner-images">
                  <img src={data.thumbnail_url} alt="tab-slider-background" />
                </div>
