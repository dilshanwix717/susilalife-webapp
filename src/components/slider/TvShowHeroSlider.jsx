...
import {executeGetContent, executeGetFeaturedTeleseries} from "../../api/endPoints.jsx";
...
const TvShowHeroSlider = memo(() => {
  ...
  const getFeaturedTeleseries = async () => {
    console.log('content Data Execute start');
    try {
      const response = await executeGetFeaturedTeleseries();
      ...
      <section className="banner-container">
        <div className="movie-banner">
          <div id="banner-detail-slider" className="banner-container">
            ...
            >
              {featuredData
                  // .filter(item => item.deviceVersion === 'landscape' && item.category === 'Teledrama' )
                  .map((item, index) => (
              <SwiperSlide className="p-0">
                <div className="movie-banner-image">
                  <img src={item.thumbnail_url} alt="movie-banner-image" />
                </div>
