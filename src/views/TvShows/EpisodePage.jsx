            ...
            <Row>
              <Col md={9} className="col-12 mb-auto">
                ...
                <ul className="p-0 mt-2 list-inline d-flex flex-wrap movie-tag">
                  {/*<li className="font-size-18">{selectedVideoData['season'] ? `S$[selectedVideoData['season']]-` : null}E{selectedVideoData['episode']}</li>*/}
                          ...
                          <div className="episode-play">
                            <Link to="/episodes"
                                  onClick={() => {
                                    ...
                                    setSelectedVideoArray(selectedVideoArray);
