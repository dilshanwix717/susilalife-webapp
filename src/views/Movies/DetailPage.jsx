...
const MovieDetail = memo(() => {
  ...
  const { videoUrls,selectedVideoData, selectedVideoArray,  } = useViewData();
  // const { videoUrls  } = useViewData();

  useEffect(() => {
    console.log("videoUrls in detail page:===>", videoUrls);
    console.log("videoUrls in detail page 360p:===>", videoUrls['360p']);
    console.log("selectedVideoData in detail page :===>", selectedVideoData['title']);
  }, [videoUrls]);

  const options = [
    { value: `${t('header.playlist')}`, label: `${t('header.playlist')}` },
    { value: `${selectedVideoData['title']}`, label: `${selectedVideoData['title']}` },
                  ...
                  <Row>
                    <Col md="9" className="mb-auto">
                      ...
                      <div className="d-flex flex-wrap align-items-center text-white text-detail flex-wrap mb-4">
                        <span className="badge bg-secondary"> {selectedVideoData['subcategory']}</span>
